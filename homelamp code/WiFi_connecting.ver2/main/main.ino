...
void setup() 
{
  ...
  wifiConfig();  // Start WiFi configuration mode (AP mode for setup or STA mode for connection)
}
...
void loop() 
{
  ...
  checkConnect(true);  // Check WiFi connection status, reconnect if disconnected
